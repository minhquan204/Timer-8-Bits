...
initial begin
	...
	wait (tb_timer_cnt_down_no_set_bit_5_TCR_clk_1.timer_8bit.counter_i.enable == 1);

	repeat (11) begin
		@ (posedge tb_timer_cnt_down_no_set_bit_5_TCR_clk_1.timer_8bit.counter_i.clk_ena);
		wait (tb_timer_cnt_down_no_set_bit_5_TCR_clk_1.timer_8bit.counter_i.clk_ena & !tb_timer_cnt_down_no_set_bit_5_TCR_clk_1.timer_8bit.counter_i.load);
		cnt_debug = cnt_debug + 1;
		if (tb_timer_cnt_down_no_set_bit_5_TCR_clk_1.timer_8bit.apb_controller_i.reg_TSR != 0) begin
	...
	@ (posedge clk);
	if (tb_timer_cnt_down_no_set_bit_5_TCR_clk_1.timer_8bit.apb_controller_i.reg_TSR != 2) begin
                $display ("run incorrectly");
                $fwrite (f, "FAIL\n");
                $fclose(f);
		#500;
